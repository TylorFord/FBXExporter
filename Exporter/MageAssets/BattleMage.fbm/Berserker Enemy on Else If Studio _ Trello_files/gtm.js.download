...
"resource": {
  ...
  "rules":[
    [["if",2],["unless",0,1],["add",0,5,10,11,12,13,14,15,16,17,22,27]],
    [["if",4,15,16],["unless",1],["add",1,8,10,16,24]],
    [["if",4,17],["unless",1],["add",2,4,10,16,20,23]],
    [["if",4,18],["unless",1],["add",3,7,10,16,20,25,28]],
    [["if",22,23],["add",6,9,10,16,20,26]],
    [["if",23,24],["add",18]],
    [["if",23,25],["add",19]],
    [["if",23],["add",21]],
    [["if",3,4],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28]],
    [["if",4,5],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28]],
    [["if",4,6],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28]],
    [["if",4,7],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28]],
    [["if",4,8],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28]],
    [["if",4,9],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28]],
    [["if",4,10],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28]],
    [["if",4,11],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28]],
    [["if",4,12],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28]],
    [["if",4,13],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28]],
    [["if",4,14],["block",0,1,2,3,4,5,7,8,10,11,12,13,14,15,16,17,20,22,23,24,25,27,28]],
    [["if",4,19],["block",3,7,10,16,20,25,27,28]],
    [["if",4,20],["block",3,7,10,16,20,25,27,28]],
    [["if",4,21],["block",3,7,10,16,20,25,27,28]]]
},
"runtime":[
[],[]
]
...
var Od=function(){},Nd=function(){return f.GoogleAnalyticsObject||"ga"},Pd=!1;var Wd=function(a){var b=vc.consumeError;if(!b||!ia(b))return;var c=[];if(a instanceof $b){var d=a.jc;if(d.length){d=d.slice();d.push({id:"main",line:0});for(var e=d.length-1;0<e;e--)ka(d[e].id)&&d.splice(e++,1);for(var g=d.length-1;0<g;g--)d[g].line=d[g-1].line;d.splice(0,1)}c=d;a=a.Uf}if(a instanceof Error){b(Vd({message:a.message},c));return}ja(a)&&b(Vd({message:a},c));};
